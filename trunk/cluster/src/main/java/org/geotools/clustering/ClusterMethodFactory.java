...
public class ClusterMethodFactory extends AbstractFeatureCollectionProcessFactory {
    ...
    public static final Parameter<FeatureCollection> POPULATION = new Parameter<FeatureCollection>(
            "population", FeatureCollection.class, Text.text("Features containing population"), Text.text("Features containing the population at risk"));
    /**
     * The source of values for population at risk. 
    ...
    static final Parameter<String> CANATTRIBUTE = new Parameter<String>(
            ...
            Text.text("The feature attribute with the incidents"),
            true, // this parameter is mandatory
            1, 1, null, null);
     ...
     * 
     * @see
     * org.geotools.process.feature.AbstractFeatureCollectionProcessFactory#addParameters(java.util
     * .Map)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.geotools.process.impl.SingleProcessFactory#getResultInfo(java.util.Map)
     */
    @Override
